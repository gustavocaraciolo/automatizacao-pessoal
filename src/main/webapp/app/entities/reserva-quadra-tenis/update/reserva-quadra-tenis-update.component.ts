...
export class ReservaQuadraTenisUpdateComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.activatedRoute.data.subscribe(({reservaQuadraTenis}) => {
      if (reservaQuadraTenis.id === undefined) {
        ...
        reservaQuadraTenis.emailDestino = 'gustavocaraciolo@gmail.com';
        reservaQuadraTenis.templateEmail = 'Email de teste!';
      }
  ...
  protected updateForm(reservaQuadraTenis: IReservaQuadraTenis): void {
    this.editForm.patchValue({
      ...
      segundafeira: reservaQuadraTenis.segundafeira ? reservaQuadraTenis.segundafeira : null,
      tercafeira: reservaQuadraTenis.tercafeira ? reservaQuadraTenis.tercafeira : null,
      quartafeira: reservaQuadraTenis.quartafeira ? reservaQuadraTenis.quartafeira : null,
      quintafeira: reservaQuadraTenis.quintafeira ? reservaQuadraTenis.quintafeira : null,
      sextafeira: reservaQuadraTenis.sextafeira ? reservaQuadraTenis.sextafeira : null,
      sabado: reservaQuadraTenis.sabado ? reservaQuadraTenis.sabado : null,
      domingo: reservaQuadraTenis.domingo ? reservaQuadraTenis.domingo : null,
    });
  }
