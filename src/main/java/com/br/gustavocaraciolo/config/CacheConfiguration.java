package com.br.gustavocaraciolo.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.br.gustavocaraciolo.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.br.gustavocaraciolo.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.br.gustavocaraciolo.domain.User.class.getName());
            ...
            createCache(cm, com.br.gustavocaraciolo.domain.Atividade.class.getName() + ".atividades");
