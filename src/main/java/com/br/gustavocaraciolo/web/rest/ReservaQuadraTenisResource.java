    ...
    public ResponseEntity<ReservaQuadraTenis> partialUpdateReservaQuadraTenis(
        ...
        Optional<ReservaQuadraTenis> result = reservaQuadraTenisRepository
            ...
            .map(existingReservaQuadraTenis -> {
                ...
                if (reservaQuadraTenis.getInstant() != null) {
                    existingReservaQuadraTenis.setInstant(reservaQuadraTenis.getInstant());
                }
                if (reservaQuadraTenis.getDuration() != null) {
                    existingReservaQuadraTenis.setDuration(reservaQuadraTenis.getDuration());
                }
                if (reservaQuadraTenis.getUuid() != null) {
                    existingReservaQuadraTenis.setUuid(reservaQuadraTenis.getUuid());
                }
