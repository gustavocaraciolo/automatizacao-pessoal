...
class ReservaQuadraTenisResourceIT {
    ...
    private static final String DEFAULT_EMAIL_ORIGEM = "AAAAAAAAAA";
    private static final String UPDATED_EMAIL_ORIGEM = "BBBBBBBBBB";
    ...
    public static ReservaQuadraTenis createEntity(EntityManager em) {
        ReservaQuadraTenis reservaQuadraTenis = new ReservaQuadraTenis()
            .emailOrigem(DEFAULT_EMAIL_ORIGEM)
    ...
    public static ReservaQuadraTenis createUpdatedEntity(EntityManager em) {
        ReservaQuadraTenis reservaQuadraTenis = new ReservaQuadraTenis()
            .emailOrigem(UPDATED_EMAIL_ORIGEM)
    ...
    void createReservaQuadraTenis() throws Exception {
        ...
        assertThat(testReservaQuadraTenis.getEmailOrigem()).isEqualTo(DEFAULT_EMAIL_ORIGEM);
    ...
    @Test
    @Transactional
    void checkEmailOrigemIsRequired() throws Exception {
        int databaseSizeBeforeTest = reservaQuadraTenisRepository.findAll().size();
        // set the field null
        reservaQuadraTenis.setEmailOrigem(null);
    ...
    @Test
    @Transactional
    void checkTemplateEmailIsRequired() throws Exception {
        int databaseSizeBeforeTest = reservaQuadraTenisRepository.findAll().size();
        // set the field null
        reservaQuadraTenis.setTemplateEmail(null);
    ...
    void getAllReservaQuadraTenis() throws Exception {
        ...
        restReservaQuadraTenisMockMvc
            ...
            .andExpect(jsonPath("$.[*].emailOrigem").value(hasItem(DEFAULT_EMAIL_ORIGEM)))
            .andExpect(jsonPath("$.[*].emailDestino").value(hasItem(DEFAULT_EMAIL_DESTINO)))
            .andExpect(jsonPath("$.[*].templateEmail").value(hasItem(DEFAULT_TEMPLATE_EMAIL)))
    ...
    void getReservaQuadraTenis() throws Exception {
        ...
        restReservaQuadraTenisMockMvc
            ...
            .andExpect(jsonPath("$.emailOrigem").value(DEFAULT_EMAIL_ORIGEM))
            .andExpect(jsonPath("$.emailDestino").value(DEFAULT_EMAIL_DESTINO))
            .andExpect(jsonPath("$.templateEmail").value(DEFAULT_TEMPLATE_EMAIL))
    ...
    void putNewReservaQuadraTenis() throws Exception {
        ...
        ReservaQuadraTenis testReservaQuadraTenis = reservaQuadraTenisList.get(reservaQuadraTenisList.size() - 1);
        assertThat(testReservaQuadraTenis.getEmailOrigem()).isEqualTo(UPDATED_EMAIL_ORIGEM);
    ...
    void partialUpdateReservaQuadraTenisWithPatch() throws Exception {
        ...
        partialUpdatedReservaQuadraTenis.templateEmail(UPDATED_TEMPLATE_EMAIL);
