...
class ReservaQuadraTenisResourceIT {
    ...
    void createReservaQuadraTenis() throws Exception {
        ...
        assertThat(testReservaQuadraTenis.getInstant()).isEqualTo(DEFAULT_INSTANT);
        assertThat(testReservaQuadraTenis.getDuration()).isEqualTo(DEFAULT_DURATION);
        assertThat(testReservaQuadraTenis.getUuid()).isEqualTo(DEFAULT_UUID);
    }
    ...
    void putNewReservaQuadraTenis() throws Exception {
        ...
        assertThat(testReservaQuadraTenis.getInstant()).isEqualTo(UPDATED_INSTANT);
        assertThat(testReservaQuadraTenis.getDuration()).isEqualTo(UPDATED_DURATION);
        assertThat(testReservaQuadraTenis.getUuid()).isEqualTo(UPDATED_UUID);
    }
    ...
    void partialUpdateReservaQuadraTenisWithPatch() throws Exception {
        ...
        partialUpdatedReservaQuadraTenis.semana(UPDATED_SEMANA).duration(UPDATED_DURATION).uuid(UPDATED_UUID);
